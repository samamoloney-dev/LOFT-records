...
import { CONTINUOUS_IMPROVEMENT_ROLES, canAccessCertificates } from './lib/roles';
          ...
          <ProtectedRoute>
            <Shell>
              <Routes>
                ...
                <Route path="/certificates" element={<ProtectedRoute allow={canAccessCertificates}><CertificateGenerator /></ProtectedRoute>} />
